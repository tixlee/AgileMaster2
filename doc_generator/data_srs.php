...
<html>
	...
	<body>
		<div class="section1">
			...
			<h2>Project Name</h2>
			<p><?php echo $request['project_name'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['system_specification'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['external_interface_requirements_user_interfaces'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['external_interface_requirements_software_interface'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['external_interface_requirements_communication_interface'] ?></p>
		</div>
		...
		<div class="section">
			...
			<h3>5.1 Usability</h3>
			<p><?php echo $request['non_functional_requirements_usability'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['non_functional_requirements_reliability'] ?></p>
		</div>
		...
		<div class="section">
			<h3>5.3 Security</h3>
			<p><?php echo $request['non_functional_requirements_security'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['non_functional_requirements_portability'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['non_functional_requirements_maintainability'] ?></p>
		</div>
		...
		<div class="section">
			...
			<p><?php echo $request['non_functional_requirements_availability'] ?></p>
		</div>
