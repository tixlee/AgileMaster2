<?php
   ...
   if(isset($_POST['save'])){
   	...
   	insert_custom_draft($userId, $document_name, $custom);
            ...
            <section class="content">
               <div class="bg-custom" >
                  <div class="bg-img" style="text-align: center;">
                     <h4 class="m-4 font-weight-bold">Self-Customized Documents</h4>
                  ...
                  <div class="card shadow mb-4">
                     <div class="card-body">
                        <form method="POST" name="createDoc" id="DocCreator"  enctype="multipart/form-data">
                           ...
                           <div class="forms-row">
                              <div class="value">
                                 <textarea type="text" class="mytextarea" id="custom" name="custom" placeholder="Enter your own document." rows="25"></textarea>
                              </div>
                           </div>
                           <br>
                           <div class="row">
