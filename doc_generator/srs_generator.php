	...
	<div class="content-wrapper">
		...
		<section class="content">
			...
			<div class="forms-row">
								...
								<div class="value">
									<textarea type="text" class="mytextarea" id="project_name" name="project_name" placeholder="Enter the project name."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="team_member" name="team_member" placeholder="Enter the team member."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="purpose" name="purpose" placeholder="Enter the purposes of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="scope" name="scope" placeholder="Enter the scope of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="definitions_acronyms_abbreviations" name="definitions_acronyms_abbreviations" placeholder="Enter the Definitions, Acronyms and Abbreviations of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="business_rules" name="business_rules" placeholder="Enter the Business Rules of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="system_specification" name="system_specification" placeholder="Enter the System Specification of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="system_features" name="system_features" placeholder="Enter the System Features of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="user_classes_characteristics" name="user_classes_characteristics" placeholder="Enter the User Classes Characteristics of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="design_implementation_constraints" name="design_implementation_constraints" placeholder="Enter the Design and Implementation Constraints of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="assumptions" name="assumptions" placeholder="Enter the Assumptions of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="operating_environment" name="operating_environment" placeholder="Enter the Operating Environment of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="use_case" name="use_case" placeholder="Enter the use case details."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="external_interface_requirements_user_interfaces" name="external_interface_requirements_user_interfaces" placeholder="Enter the User Interface of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="external_interface_requirements_software_interface" name="external_interface_requirements_software_interface" placeholder="Enter the Software Interface of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="external_interface_requirements_communication_interface" name="external_interface_requirements_communication_interface" placeholder="Enter the Communication Interface of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="non_functional_requirements_usability" name="non_functional_requirements_usability" placeholder="Enter the Non Functional Requirements - usability of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="non_functional_requirements_reliability" name="non_functional_requirements_reliability" placeholder="Enter the Non Functional Requirements - reliability of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="non_functional_requirements_security" name="non_functional_requirements_security" placeholder="Enter the Non Functional Requirements - security of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="non_functional_requirements_portability" name="non_functional_requirements_portability" placeholder="Enter the Non Functional Requirements - portability of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="non_functional_requirements_maintainability" name="non_functional_requirements_maintainability" placeholder="Enter the Non Functional Requirements - maintainability of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="non_functional_requirements_availability" name="non_functional_requirements_availability" placeholder="Enter the Non Functional Requirements - availability of the project."></textarea>
								</div>
							</div>
							...
							<div class="forms-row">
								...
								<div class="value">
									<textarea class="mytextarea" id="management_process" name="management_process" placeholder="Enter the Management Process of the project."></textarea>
								</div>
							</div>
