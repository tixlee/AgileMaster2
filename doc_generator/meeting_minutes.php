...
if(isset($_POST['save'])){
	...
	insert_meeting_minutes_draft($userId, $document_name, $title, $objective, $date, $time, $location, $called_by, $note_taker, $time_keeper, 
	$attendees, $agenda_items, $decisions, $new_action_items, $notes_info);
        echo "<script>alert('Your Meeting Minutes had been saved');</script>";
        echo "<script>window.location.href ='meeting_minutes.php'</script>";
}
						...
						<div class="card-body">
                            ...
                            <hr>
								...
								<div class="forms-row">
									...
									<div class="value">
										<textarea type="text" class="mytextarea" id="decisions" name="decisions" placeholder="Enter the decisions made in the meeting."></textarea>
									</div>
								</div>
