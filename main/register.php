...
if(isset($_POST['create'])){
    ...
    if($rslt >0){
        ...
        if($password == $password2){
            ...
            insert_user($fname, $lname, $age, $occupation, $city, $country, $email, $password, $photo, $ran_id);
							...
							<form method="post" enctype="multipart/form-data">
                                ...
                                <div  class="row">
                                    <div class="col">
                                        ...
                                        <input type="number" name="age" id="age" class="form-control" placeholder="Age" required autocomplete="off">
                                    </div>
                                    <div class="col">
                                        <label for="occupation" class="sr-only">Occupation</label>
                                        <input type="text" name="occupation" id="occupation" class="form-control" placeholder="Occupation" required autocomplete="off">
                                    </div>
                                </div>
                                <div  class="row">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="country" id="country" class="form-control" placeholder="Country" required autocomplete="off">
                                    </div>
                                </div>
