...
if(isset($_POST['next'])){
  ...
  <a href='https://www.agilemaster.net/main/reset-password'>https://www.agilemaster.net/main/reset-password</a> 
  <br>
  <p>If you didn't mean to reset your password, then you can just ignore this email. Your password will not be changed.</p>
	<p><b>Regards,</b></p>
