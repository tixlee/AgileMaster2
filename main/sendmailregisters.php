...
if(isset($_POST['create'])){
  ...
  try{
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Welcome to Agile Master!';
    $mail->Body = 
	"
	<p><b>Dear Mr/Ms,</b></p> <br>
	<p><b><i>Welcome to Agile Master.</i></b></p>
	...
	<p>Try our system on <a href='https://www.agilemaster.net/'>https://www.agilemaster.net/</a></p> <br>
	<p><b>Regards,</b></p>
