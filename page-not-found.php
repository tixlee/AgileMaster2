...
<!--  <link href="dependencies/css/style.css" rel="stylesheet">-->
    <link href="dependencies/css/style.min.css" rel="stylesheet">
</head>
...
<body>
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
    ...
    <!-- All Required js -->
    <!-- ============================================================== -->
    <script src="dependencies/scripts/jquery.min.js"></script>
