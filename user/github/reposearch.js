    ...
    $.ajax({
      ...
      $.ajax({
        ...
        $.each(repos, function(index, repo){
          $('#repos').append(`
            <div class="card border-primary" style="margin-top: 1%; padding: 1%;">
              <div class="row">
                <div class="col-md-7">
      ...
      $('#profile').html(`
        <div class="card border-primary mb-3" style="max-width: 100rem;">
          ...
          <div class="card-body">
            <div class="row">
            <div class="col-md-2">
              <img class="img-thumbnail avatar" src="${user.avatar_url}"><br><br>
              <a target="_blank" class="btn btn-primary btn-block" href="${user.html_url}"  style="background-color: red;">View Profile</a>
            </div>
            <div class="col-md-9">
        ...
        <h3 class="page-header">Repository List</h3>
        <div id="repos"></div>
		<br><br>
        `);
    });
