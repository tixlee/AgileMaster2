...
$user_name = $yRow['fname'] . " " . $yRow['lname'];
   ...
   if(isset($_POST['create'])){
       ...
       $query = $conn->query("SELECT * FROM `project` WHERE `project_id` = '". $_POST['project_id'] ."'") or die(mysqli_error());
       $b_query = $query->fetch_array();
                $project_name = $b_query['project_name'];
       
       
       $recipient_id = $_POST["user_id"];
       insert_notification($recipient_id, "$user_name assigned bug to you ($bug_name) in $project_name project" );
                                       ...
                                       <table class="table table-bordered" id="dataTables" width="100%" cellspacing="0">
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td >
                                                   <?php echo $assigneeRow['fname'] . " " . $assigneeRow['lname'];?>
                                                </td>
                                                <td >
                                          ...
                                          <tbody>
                                             <?php
                                                ...
                                                while($buugRow = mysqli_fetch_array($getAssignedBugByUserId))
                                                {
                                                    ...
                                                    $getAssigneeBugByUserId = getAssigneeBugByUserId($buugRow['assignee']);
                                                    $assigneeRow = mysqli_fetch_array($getAssigneeBugByUserId);
                                                    
                                                    $getProjectBugByUserId = getProjectBugByUserId($buugRow['project_id']);
                                                    $projbugRow = mysqli_fetch_array($getProjectBugByUserId);
                                                ?>
                                             <tr >
                                                <td > 
                                                ...
                                                <td >
                                                   <?php echo $assignedRow['fname'] . " " . $assignedRow['lname'];?>
                                                </td>
                                                <td >
                                          ...
                                          <tbody>
                                             <?php
                                                ...
                                                while($buuggRow = mysqli_fetch_array($getResolvedBugByUserId))
                                                {
                                                    ...
                                                    $getProjectBugByUserId = getProjectBugByUserId($buuggRow['project_id']);
                                                    $projbugRow = mysqli_fetch_array($getProjectBugByUserId);
                                                ?>
                                             <tr >
                                                <td > 
