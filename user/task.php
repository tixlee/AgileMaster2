<?php
   ...
   //    $user_id = $_POST['user_id'];
       ...
       $mrRow = mysqli_fetch_array($get_not_comment);
           $recipient_id = $_POST["user_id"];
           insert_notification($recipient_id, "$user_name assigned $task_name task in $board_name board" );
                                          ...
                                          <div class="row col-md-12 col-xm-6 mb-3 ">
                                             ...
                                             <select data-live-search="true" title="Please select member" name="user_id" class="form-control selectpicker col-sm-12">
                                                <?php
                                                   ...
                                                   {
                                                   ?>
                                                <option value="<?php echo $u_query['user_id']; ?>" <?php if ($user_id == $u_query['user_id']) {echo "selected";} ?> required><?php echo $u_query['fname'] . " " . $u_query['lname']; ?></option>
                                                <?php
                                                   }
                                                   ?>
                                             </select>
