...
$user_name = $yRow['fname'] . " " . $yRow['lname'];
   ...
   //    $user_id = $_POST['user_id'];
       ...
       while ($mrRow = mysqli_fetch_array($get_not_comment)){
           ...
           insert_notification($recipient_id, "$user_name uploaded new file in $project_name project" );}
                           ...
                           <div class="modal-body">
                              <form method="POST" enctype="multipart/form-data">
                                 ...
                                 <div class="row col-lg-12">
                                    ...
                                    <select data-live-search="true" title="Please select document type" name="document_type" class="form-control selectpicker col-sm-12 col-md-12">
                     ...
                     <div class="card-body">
                        <div class="table-responsive">
                           <table class="table table-bordered" id="dataTables" width="100%" cellspacing="0">
                              ...
                              <tbody>
                                 <?php                         
                                    $query = $conn->query("SELECT * FROM `file_storage` NATURAL JOIN `user_project` NATURAL JOIN `users` WHERE `project_id` = '$row[project_id]'") or die(mysqli_error());
