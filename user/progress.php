            ...
            <section class="content">
               ...
               <div class="container-fluid">
                  <div class="card card-danger card-outline">
                     ...
                     <div class="card-body">
                        <p class="card-title" ><i class="font-weight-normal">Tasks Bar Chart below showing the total task that are assigned to the user in different state. The Performance for Board chart showing the overall performance of the user in specific selected board. Project Manager are allowed to view the overall task that are assigned to all of the members and the overall performance for the board in that project.</i>
                        </p>
                     </div>
                  </div>
